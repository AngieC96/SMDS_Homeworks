...
We can see that the blue curve of $s^2_b$ is more shifted to the left with respect to the red curve of $s^2$. In the end $s^2$, being unbiased, shold be preferred.
