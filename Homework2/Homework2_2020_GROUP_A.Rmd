...
We can see that $s^2_b$ is a biased estimator for the variance because its curve is not centered on $1$: it is slightly farther.
...
We can see that the blue curve of $s^2_b$ is more shifted to the left with respect to the red curve of $s^2$, which in average seems closer to the true value of the variance. In the end $s^2$, being unbiased, should be preferred.
...
$$
\frac{\partial l(\gamma,\beta;y)}{\partial \gamma} = \frac{n}{\gamma} - n\log(\beta)  +  \sum_{i=1}^n \log \left( \frac{y_i}{\beta}\right) \left( \frac{y_i}{\beta} \right)^\gamma \\
\frac{\partial l(\gamma,\beta;y)}{\partial \beta} = -\frac{n\gamma}{\beta} + \frac{\gamma}{\beta} \sum_{i=1}^n \left(\frac{y^i}{\beta}\right)^\gamma
$$
...
&= - \frac{n}{\beta} + \frac 1\beta \left( 1 + \gamma \log \left( \frac{y_i}{\beta} \right) \right) \sum_{i=1}^n \left( \frac{y_i}{\beta} \right)^\gamma
\end{align*}
$$
...
J(\gamma, \beta; y) &= -\frac{\partial^2 l(\gamma,\beta;y)}{\partial\gamma\partial\beta} = \frac{n}{\beta}  -  \frac 1\beta \left( 1 + \gamma \log \left( \frac{y_i}{\beta} \right) \right) \sum_{i=1}^n \left( \frac{y_i}{\beta} \right)^\gamma \\
